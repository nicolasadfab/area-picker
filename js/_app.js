        ...
        endpoints: {
            ...
            loadIframe: function (e)
            {
                ...
                var local = {
                        ...
                        width: '100%',
                        //container
                        onReady: Events.endpoints.easyXDMReady
                },
                remote = {
                        ...
                        local: {
                            events: function (e)
                            {
                                ...
                                console.log(res);
                                if(e.callback === 'clicked') {
                                    
                                    App.logic.exdm.removeEvents(
                                        {
                                            "events": 
                                            {
                                                document: {
                ...
                App.logic.exdm = new easyXDM.Rpc(local, remote);
